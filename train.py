...
# def catch(data, data2, data3, data4, data5, label):
...
#     return data, data2, data3, data4, data5, label



# from model import MKey_Net_DiladCNNBiLSTM_Attention, MKey_Net_DiladCNNBiLSTM_GCN_Attention, MKey_Net_DiladCNNBiLSTM_GCN_GCN_AttentionCat
...
#     # data get
#     X_train, K_train, N_train, F_train, A_train, y_train = train[0], train[1], train[2], train[3], train[4], train[5]

#     # data and label preprocessing
#     y_train = tf.keras.utils.to_categorical(y_train)
#     X_train, K_train, N_train, F_train, A_train, y_train = catch(X_train, K_train, N_train, F_train, A_train, y_train)
#     y_train[y_train > 1] = 1
...
#         if model_path == 'MKey_Net_DiladCNNBiLSTM_Attention':
#             model = MKey_Net_DiladCNNBiLSTM_Attention(length, out_length, para)
#         elif model_path == 'MKey_Net_DiladCNNBiLSTM_GCN_Attention':
#             model = MKey_Net_DiladCNNBiLSTM_GCN_Attention(length, out_length, para)
#         elif model_path == 'MKey_Net_DiladCNNBiLSTM_GCN_GCN_AttentionCat':
#             model = MKey_Net_DiladCNNBiLSTM_GCN_GCN_AttentionCat(length, out_length, para)
#         else:
#             print('no model')
...
#         print(F_train.shape)
#         print(A_train.shape)
#         model.fit([X_train, K_train, N_train, F_train, A_train], y_train, epochs=1, batch_size=32, verbose=2)
#         # each_model = os.path.join(model_path, 'model' + str(counter) + '.h5')
#         # model.save(each_model)
#         name = 'model' + str(counter) +'.h5'
